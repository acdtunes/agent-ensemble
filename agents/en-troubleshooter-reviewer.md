---
name: en-troubleshooter-reviewer
...
**How**: Use the Read tool to load files from `skills/troubleshooter-reviewer/`
...
Skills path: `skills/troubleshooter-reviewer/`
