---
name: en-platform-architect-reviewer
...
# en-platform-architect-reviewer
...
**How**: Use the Read tool to load files from `skills/platform-architect-reviewer/`
...
Skills path: `skills/platform-architect-reviewer/`
