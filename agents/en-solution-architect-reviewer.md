---
name: en-solution-architect-reviewer
...
# en-solution-architect-reviewer
...
**How**: Use the Read tool to load files from `skills/solution-architect-reviewer/`
...
Skills path: `skills/solution-architect-reviewer/`
