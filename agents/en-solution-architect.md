...
**How**: Use the Read tool to load files from `skills/solution-architect/`
...
| Roadmap (DELIVER only) | `roadmap-design` | Only when invoked via /en:roadmap or /en:deliver — never during DESIGN wave |
| 6 Peer Review and Handoff | `critique-dimensions` | Always — review dimension scoring for self-validation before handoff |

Skills path: `skills/solution-architect/`
...
- Does not create roadmap.json during DESIGN wave. Roadmap creation belongs exclusively to DELIVER wave via /en:roadmap or /en:deliver.
