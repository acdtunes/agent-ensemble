---
name: en-software-crafter-reviewer
...
- `skills/software-crafter/` — shared skills (`review-dimensions`, `tdd-methodology`)
- `skills/software-crafter-reviewer/` — reviewer-specific skills (`tdd-review-enforcement`)
