...
**How**: Use the Read tool to load files from `skills/researcher-reviewer/`
...
Skills path: `skills/researcher-reviewer/`
...
reviewer: "en-researcher-reviewer (Scholar)"
issues_identified:
  source_bias:
