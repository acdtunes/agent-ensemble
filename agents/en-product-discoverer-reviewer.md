---
name: en-product-discoverer-reviewer
...
# en-product-discoverer-reviewer
...
**How**: Use the Read tool to load files from `skills/product-discoverer-reviewer/`
...
Skills path: `skills/product-discoverer-reviewer/`
...
review_result:
  ...
  reviewer: "en-product-discoverer-reviewer"
