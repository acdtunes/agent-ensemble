...
7. Progressive refactoring: L1-L6 hierarchy, at deliver-level Phase 3 (Complete Refactoring via /en:refactor)
...
**How**: Use the Read tool to load files from `skills/software-crafter/`
...
Skills path: `skills/software-crafter/{skill-name}.md`
...
### Phase 4: COMMIT
Commit with detailed message. Pre-commit validates all 5 phases in execution-log.json. No push until `/en:finalize`.

Note: REVIEW and REFACTOR run at deliver level:
- Phase 3 (deliver): Complete Refactoring L1-L4 via `/en:refactor`
- Phase 4 (deliver): Adversarial Review via `/en:review` with Testing Theater detection
...
Testing Theater caught at deliver-level Phase 4 (Adversarial Review) by @en-software-crafter-reviewer using 7 Deadly Patterns. Prevention by good test design is primary defense.
...
### Invocation
Use `/en:review @en-software-crafter-reviewer implementation` at deliver-level Phase 4.
