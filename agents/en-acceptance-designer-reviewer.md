---
name: en-acceptance-designer-reviewer
...
# en-acceptance-designer-reviewer
...
**How**: Use the Read tool to load files from `skills/acceptance-designer/`
...
Skills path: `skills/acceptance-designer/`
