---
name: en-product-owner-reviewer
...
**How**: Use the Read tool to load files from `skills/product-owner-reviewer/`
...
Skills path: `skills/product-owner-reviewer/`
...
review_result:
  ...
  reviewer: "en-product-owner-reviewer (Eclipse)"
