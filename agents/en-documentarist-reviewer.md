---
name: en-documentarist-reviewer
...
- `divio-framework` from `skills/documentarist/`
- `review-criteria` from `skills/documentarist-reviewer/`
...
|-------|------|------|---------|
| 1 Independent Analysis | `divio-framework` | `skills/documentarist/` | Always — DIVIO decision tree for independent classification |
| 2 Assessment Comparison | `review-criteria` | `skills/documentarist-reviewer/` | Always — critique dimensions and verdict decision matrix |

Skills paths: `skills/documentarist/` and `skills/documentarist-reviewer/`
