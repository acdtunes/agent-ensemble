...
# EN-MUTATION-TEST: Feature-Scoped Mutation Testing

**Wave**: QUALITY_GATE
**Agent**: Crafter (en-software-crafter)
...
```bash
/en:mutation-test des-hook-enforcement tests/des/
```
...
```bash
/en:mutation-test auth-upgrade tests/auth/
```
...
```bash
/en:mutation-test payment-gateway tests/payment/
```
