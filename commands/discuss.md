...
# EN-DISCUSS: Jobs-to-be-Done Analysis, UX Journey Design, and Requirements Gathering

**Wave**: DISCUSS (wave 2 of 6) | **Agent**: Luna (en-product-owner) | **Command**: `/en:discuss`
...
- [ ] Handoff accepted by en-solution-architect (DESIGN wave)

## Next Wave

**Handoff To**: en-solution-architect (DESIGN wave) + en-platform-architect (DEVOPS wave, KPIs only)
...
```
/en:discuss --phase=jtbd onboarding-flow
```
...
```
/en:discuss --phase=journey release-nwave
```
...
```
/en:discuss --phase=requirements new-plugin-system
```
