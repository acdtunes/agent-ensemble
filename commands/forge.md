...
# EN-FORGE: Create Agent (V2)

**Wave**: CROSS_WAVE
**Agent**: Zeus (en-agent-builder)
...
Execute /en:forge to create {agent-name} agent.
...
```
agents/en-{agent-name}.md
skills/{agent-name}/*.md    (if Skills needed)
```
