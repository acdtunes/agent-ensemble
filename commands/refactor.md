...
# EN-REFACTOR: Systematic Code Refactoring

**Wave**: CROSS_WAVE
**Agent**: Crafty (en-software-crafter)
**Command**: `*refactor`
...
Execute /en:refactor for {target-class-or-module}.
...
```
/en:refactor src/auth/token_manager.py --level=2 --scope=module
```
...
```
/en:refactor src/billing/ --level=6 --scope=module --mikado_planning=true
```
...
```
/en:refactor src/des/domain/ --from=1 --to=3 --scope=module
```
...
```
/en:refactor src/des/cli/verify.py --level=3 --scope=file
```
