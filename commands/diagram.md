...
# EN-DIAGRAM: Architecture Diagram Generation

**Wave**: CROSS_WAVE | **Agent**: Morgan (en-solution-architect) | **Command**: `*create-diagrams`
...
Execute /en:create-diagrams for {architecture-component}.
...
```
/en:diagram payment-service --diagram_type=component --format=mermaid --level=container
```
