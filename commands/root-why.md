...
# EN-ROOT-WHY: Toyota 5 Whys Root Cause Analysis

**Wave**: CROSS_WAVE
**Agent**: Rex (en-troubleshooter)
...
Execute /en:investigate-root-cause for {problem-statement}.
...
When invoked as part of `/en:deliver` Phase 3.5, analyze across 4 categories:
...
```
/en:root-why "Integration tests fail intermittently on CI but pass locally"
```
