...
# EN-MIKADO: Complex Refactoring with Mikado Method
...
Execute /en:mikado for {refactoring-goal}.
...
```
/en:mikado "Extract shared domain model from monolithic service layer"
```
