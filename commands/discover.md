...
**Wave**: DISCOVER | **Agent**: Scout (en-product-discoverer)
...
@en-product-discoverer

Execute /en:discover for {product-concept-name}.
...
Refer to Scout's quality gates in agents/en-product-discoverer.md.
...
**Handoff To**: en-product-owner (DISCUSS wave)
...
```
/en:discover invoice-automation
```
