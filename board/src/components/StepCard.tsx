...
export const StepCard = ({ card, onCardClick, isHighlighted = false }: StepCardProps) => {
  ...
  return (
    <div
      ...
      className={`overflow-hidden rounded-b min-h-[160px] max-w-[240px] flex flex-col bg-gray-900/80 backdrop-blur-sm p-3 shadow-sm ${topBarColor} ${animationClasses}${isClickable ? ' cursor-pointer' : ''} ${highlightClasses}`}
