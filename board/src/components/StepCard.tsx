...
export const StepCard = ({ card, onCardClick }: StepCardProps) => {
  ...
  return (
    <div
      ...
      className={`overflow-hidden rounded-b min-h-[160px] flex flex-col bg-gray-900/80 backdrop-blur-sm p-2 text-sm shadow-sm ${topBarColor} ${animationClasses}${isClickable ? ' cursor-pointer' : ''}`}
